...
export const navigation: NavigationItem[] = [
  ...
  { label: "Research Evidence", path: "/research", group: "Intelligence", apiResource: "research-items" },
  ...
  { label: "Decision Records", path: "/decisions", group: "Operations", apiResource: "decision-records" },
