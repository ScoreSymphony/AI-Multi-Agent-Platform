...
export function renderShellRoute({
  ...
  if (path === "/research") return <ManifestResourcesPage state={manifestState} manifest={manifest} label="Research Evidence" resources={RESEARCH_RESOURCES}><ResearchPage client={researchClient} commands={manifestCommands} /></ManifestResourcesPage>;
  if (researchMatch) return <ManifestResourcesPage state={manifestState} manifest={manifest} label="Research Evidence" resources={RESEARCH_RESOURCES}><ResearchDetailPage client={researchClient} decisions={decisionRecordClient} researchItemId={researchMatch.researchItemId} commands={manifestCommands} /></ManifestResourcesPage>;
  ...
  if (path === "/decisions") return <ManifestResourcePage state={manifestState} manifest={manifest} label="Decision Records" resource="decision-records"><DecisionRecordsPage client={decisionRecordClient} commands={manifestCommands} /></ManifestResourcePage>;
  if (decisionRecordMatch) return <ManifestResourcePage state={manifestState} manifest={manifest} label="Decision Records" resource="decision-records"><DecisionRecordDetailPage client={decisionRecordClient} decisionRecordId={decisionRecordMatch.decisionRecordId} commands={manifestCommands} /></ManifestResourcePage>;
