...
def test_capability_assignment_submodule_compatibility_preserves_object_identity() -> None:
    ...
    from ai_multi_agent_platform.capabilities.assignments import service as canonical_service
    from ai_multi_agent_platform.capability_assignments import models as compatibility_models
    from ai_multi_agent_platform.capability_assignments import service as compatibility_service

    assert compatibility_models.CapabilityAssignmentPolicy is canonical_models.CapabilityAssignmentPolicy
    assert (
