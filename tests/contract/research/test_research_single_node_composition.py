...
def test_single_node_research_is_durable_authorized_and_search_registered(tmp_path: Path) -> None:
    async def scenario() -> None:
        ...
        item = await composition.service.create_item(
        ...
        assert restored.service.repository.get_item(item.research_item_id) == item
