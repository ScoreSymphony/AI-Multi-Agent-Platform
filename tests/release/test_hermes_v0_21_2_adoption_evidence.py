...
OLD_HERMES_REVISION = "2237be355906fbe6065ce1815711eee52b2d646e"
CANDIDATE_REVISION = "939e45c91d751fadd94dcd1b873ac3cb44846213"


def test_hermes_v0_21_2_adoption_evidence_reproduces_pass_update(
    tmp_path: Path,
    capsys,
) -> None:
    ...
    hermes["last_checked_at"] = "2026-09-11T00:00:00Z"
    ...
    exit_code = main(
        [
            ...
            str(inventory_path),
            "--observations",
            str(ROOT / "release" / "hermes-v0.21.2-observation.json"),
            "--component",
            "Hermes Agent",
            "--evidence",
            str(ROOT / "release" / "hermes-v0.21.2-validation-evidence.json"),
