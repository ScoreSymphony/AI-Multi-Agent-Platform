...
SCHEMA_EXPORTS = (
    ...
    ("TelemetryTimelineEntry", "TelemetryTimelineEntry"),
    ("TimelineItem", "TimelineItem"),
    ("TimelinePage", "TimelinePage"),
    ("UsageQualityCounts", "UsageQualityCounts"),
    ("UsageRecord", "UsageRecord"),
    ("UsageRecordPage", "UsageRecordPage"),
    ("UsageTrendPoint", "UsageTrendPoint"),
    ("UsageAggregate", "UsageAggregate"),
    ("UsageAggregatePage", "UsageAggregatePage"),
    ("UsageBudget", "UsageBudget"),
    ("UsageBudgetPage", "UsageBudgetPage"),
