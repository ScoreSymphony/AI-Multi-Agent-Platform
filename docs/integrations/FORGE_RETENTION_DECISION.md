...
Architecture authority: ADR 0013 recorded the bounded deprecation phase; ADR 0014 records the final executable removal after those gates were satisfied.
...
| Adapter documentation | `docs/integrations/FORGE_ADAPTER.md` | Retained only as a historical removal tombstone. |
