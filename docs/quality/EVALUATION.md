...
Global Search projects canonical Evaluation discovery without becoming authoritative for Evaluation state. Search consumes only the registered Control Plane Evaluation resources:
