...
| `tests/integration/distributed/test_failover_reconciliation.py` + `distributed/high_availability/reconciliation.py` | fencing, durable runtime reconciliation and deterministic before/after classification | **mixed**: pure delta classification + real failover/recovery integration | Extract reconciliation-result derivation into `distributed/high_availability/reconciliation_policy.py`; keep fencing, persistence and runtime recovery tests as integration. |
