...
The async persistence layer moves persistence-bearing Verification work out of asyncio runtime hotpaths without replacing the canonical Verification lifecycle.
