...
- Usage & Limits — canonical usage records, aggregates and budgets exposed by the Control Plane. Independent collection failures retain canonical permission/approval/unavailable/backend error semantics so healthy accounting collections remain usable without flattening failures into generic text.
