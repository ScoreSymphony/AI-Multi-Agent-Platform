...
- canonical Template/Template Instance collection forwarding, opaque cursor preservation, exact create/version/clone/fork/preview/apply/create-from-existing commands including Workflow, Capability Assignment and Model Routing Profile exporters, BrowserSession CSRF + idempotency propagation, fail-closed full-manifest gating and no fabricated generated-resource detail routes for owner domains without a canonical browser surface;
