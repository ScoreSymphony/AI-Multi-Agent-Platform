...
- manifest-gated Chat, Automation, Approval, Verification, Notification, Plugin, Memory and multi-resource Integration/Evaluation/Compute/Knowledge routing;
