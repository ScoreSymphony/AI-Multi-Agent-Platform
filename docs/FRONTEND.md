...
- canonical Template/Template Instance collection forwarding, opaque cursor preservation, exact create/version/clone/fork/preview/apply/create-from-existing commands, BrowserSession CSRF + idempotency propagation and fail-closed full-manifest gating;
