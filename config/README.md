...
Authentication bootstrap secrets are entered interactively or through explicit standard
input and are never represented as ordinary deployment configuration.
