"""Compatibility import for explicit Workspace/Task-management composition (#982).

The historical module path remains supported, but canonical behavior now lives in
``workspace_task_management_explicit_composition``.  Keeping this module behavior-free
