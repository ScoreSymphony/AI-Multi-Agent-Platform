...
This coordinator handles that second case without bypassing canonical capability invocation:
both the preferred attempt and the baseline fallback are ordinary capability-invocation calls with
the same
