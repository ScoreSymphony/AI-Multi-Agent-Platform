...
canonical Workspace snapshot/materialization when the Run binding proves that it belongs to the
same repository, while preserving the Git revision as base provenance rather than pretending dirty
