...
REGISTRY_ITEM_SCHEMA_V1: dict[str, Any] = {
    ...
    "type": "object",
    "required": [
        "schema_version", "item_id", "item_type", "name", "description", "version",
        "publisher", "source", "license", "provenance", "supported_platform",
        "dependencies", "requested_permissions", "required_capabilities", "integrity",
        "trust_status", "deprecated", "yanked",
    ],
    "properties": {
        ...
        "item_type": {
            "enum": [
                "agent", "agent_team", "tool", "plugin", "workflow", "template",
                "model_configuration", "connector", "evaluation", "documentation",
            ]
        },
        ...
        "required_connectors": {"type": "array", "items": {"type": "string"}, "uniqueItems": True},
