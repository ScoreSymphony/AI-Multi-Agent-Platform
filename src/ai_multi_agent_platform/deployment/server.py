...
from . import build_single_node_deployment
...
async def _run_restore_recovery(
    ...
    async def validate(
        ...
        return await validate_restored_single_node(
            ...
            extra_validators=(
                *single_node_restore_integrity_validators(deployment),
                *single_node_current_restore_integrity_validators(deployment),
            ),
        )
