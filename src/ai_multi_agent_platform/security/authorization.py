...
class AuthorizationAction(StrEnum):
    ...
    MODEL_ROUTING_PROFILE_LIST = "model-routing-profile:list"
    MODEL_ROUTING_PROFILE_READ = "model-routing-profile:read"
    MODEL_ROUTING_PROFILE_CREATE = "model-routing-profile:create"
    MODEL_ROUTING_PROFILE_VERSION = "model-routing-profile:version"
    MODEL_ROUTING_PROFILE_ENABLE = "model-routing-profile:enable"
    MODEL_ROUTING_PROFILE_DISABLE = "model-routing-profile:disable"
    MODEL_ROUTING_PROFILE_ASSIGN = "model-routing-profile:assign"
    ...
    EVALUATION_SUITE_LIST = "evaluation-suite:list"
    EVALUATION_SUITE_READ = "evaluation-suite:read"
    EVALUATION_RUN_LIST = "evaluation-run:list"
    ...
    TEMPLATE_CREATE_FROM_AGENT_TEAM = "template.create-from-agent-team"
