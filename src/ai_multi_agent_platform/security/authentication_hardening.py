...
class LocalAuthenticationService(_BaseLocalAuthenticationService):
    ...
    def __init__(
        ...
        *,
        ...
        self._mobile_pairing = MobilePairingManager(
    ...
    def create_mobile_pairing_challenge(
        ...
        *,
        ...
        return self._mobile_pairing.create(
            user_id,
            server_origin=server_origin,
            scope=(scope or CredentialScope()).to_json(),
            ttl=ttl,
            now=current,
            correlation_id=correlation_id,
        )
    ...
    def complete_mobile_pairing(
        ...
        *,
        ...
        return self._mobile_pairing.complete(
            request_id,
            proof,
            device_name=device_name,
            device_metadata=device_metadata,
            issuer=self._issue_mobile_device_credential,
            now=_current(now),
            correlation_id=correlation_id,
        )
    ...
    def rename_mobile_device(
        ...
        *,
        ...
        normalized_name, _ = mobile_device_metadata(
            device_name,
            {},
    ...
    def _issue_mobile_device_credential(
        self,
        user_id: str,
        *,
        device_name: str,
        ...
        return self.create_personal_access_token(
            user_id,
            purpose=f"mobile-device:{device_name}",
            now=now,
            scope=CredentialScope.from_json(dict(scope)),
            metadata=metadata,
        )
